...
BEGIN
  ...
  -- 2. Insert Post
  INSERT INTO posts (user_id, content, latitude, longitude, location_name, repost_of, is_anonymous)
  VALUES (auth.uid(), p_content, p_latitude, p_longitude, p_location_name, p_repost_of, p_is_anonymous)
