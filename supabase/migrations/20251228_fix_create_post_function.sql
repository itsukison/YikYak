-- Migration: Fix create_post function to set status and location
-- Date: 2025-12-28
-- Description: Updates create_post RPC to include status='active' and location geography
--              so that newly created posts appear in feed queries
