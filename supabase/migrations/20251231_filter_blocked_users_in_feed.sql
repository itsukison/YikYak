-- Migration: Filter blocked users from feed
-- Date: 2025-12-31
-- Description: Updates get_feed_v2 to exclude posts from blocked users
...
-- Recreate with blocked user filtering
...
COMMENT ON FUNCTION get_feed_v2 IS 'Get feed posts with blocked user filtering';
